...
/*Edited*/
//bookly-addon-service-extras\frontend\modules\booking\templates
//line 68
...
<div class="bookly-extra-step">
    ...
    <?php if ( in_array( 'summary', $show ) ) : ?>
        <div class="bookly-box bookly-extras-summary bookly-js-extras-summary"><?php _e( 'Summary', 'bookly-service-extras' ) ?>:<?php if ( $chain_price !== null ): ?> <?php echo Price::format( $chain_price ) ?><?php endif ?><span><?php echo ( $amount ) ? ' + ' . Price::format( $amount ) : '' ?></span> Per Person</div>
    <?php endif ?>
</div>
